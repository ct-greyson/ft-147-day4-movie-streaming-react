...
const Login = () => {
  ...
  const handleSubmit = (event) => {
    ...
    // values need to be saved as strings, so if you are saving an object type for example, make sure you use JSON.stringify
    sessionStorage.setItem(
      "user",
      JSON.stringify({ name: username, isLoggedIn: true })
    );
