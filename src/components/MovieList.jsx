...
import { getWatchListData } from "../features/watchListSlice";
...
const MovieList = ({ listType }) => {
  ...
  }, [movieList]); // if our movieList changes (by either adding an item or losing an item) recalculate the average popularity.  if it has NOT changed, don't do this calculation again
